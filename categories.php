		...
		<div class="col-xs-12">
			<div class="box-content">
				...
				<div class="dropdown js__drop_down">
					<button type="button" class="btn btn-xs btn-primary pull-right button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"><i class="ico ico-left fa fa-plus"></i>Add Supplier</button>
				</div>
				<div class="remove-messages"></div>
				<table class="table table-striped manord" id="manageCategoriesTable">
					<thead> 
						<tr>
							<th style="width:7%;">#</th>
...
<script src="http://gramtool.net/inv/categories.js"></script>
