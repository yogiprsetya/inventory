	...
	<div class="main-content">
		<div class="col-xs-12">
			<div class="box-content">
				<h4 class="box-title">Manage Supplier</h4>
				<div class="dropdown js__drop_down">
					<button type="button" class="btn btn-xs btn-primary pull-right button1" data-toggle="modal" data-target="#addBrandModel"><i class="ico ico-left fa fa-plus"></i>Add Supplier</button>
				</div>
				<div class="remove-messages"></div>
				<table class="table table-striped manord" id="manageBrandTable">
					<thead> 
						<tr>
							<th style="width:7%;">#</th>
							<th>Supplier</th>
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editBrandName" placeholder="Supplier" name="editBrandName" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
...
<script src="http://gramtool.net/inv/brand.js"></script>
