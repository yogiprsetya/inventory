...
if($_POST) {	
  ...
  $shipping 				= $_POST['shipping'];
	...
	$sql = "UPDATE orders SET order_date = '$orderDate', client_name = '$clientName', client_contact = '$clientContact', alamat = '$alamat', sub_total = '$grandTotalValue', note = '$note', platform = '$platform', shipping = '$shipping', order_status = 1 WHERE order_id = {$orderId}";	
	$connect->query($sql);
